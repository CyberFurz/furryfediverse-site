      ...
      <div className="flex flex-col">
        <div className="py-4">
          <div className="bg-gray-400 text-slate-800 rounded-md p-3">
            ...
            >
              <label className="text-2xl font-bold">Instance URI</label>
              <br />
              <input
                type="text"
                name="Instance URI"
              ...
              <br />
              <label className="text-2xl font-bold">SFW/NSFW Level</label>
              <br />
              <select
                id="type"
                name="nsfwflag"
                onChange={(e) => setForm({ ...form, nsfwflag: e.target.value })}
              >
              ...
              <br />
              <label className="text-2xl font-bold">Agreements</label>
              <br />
              <p className="text-base">
                You agree to allow FurryFediverse to scape your instance's
                endpoint "/api/v1/instance" for up to date information on your
                instance. We will not collect any other data from your instance.
              </p>
              <input
                type="checkbox"
                name="scraping"
              ...
              <br />
              <p className="text-base">
                You promise to notify your users if you plan to shutdown or can
                no longer operate your instance with a 30 day notice so they can
                migrate elsewhere.
              </p>
              <input type="checkbox" name="notify" required />
              <br />
              <p className="text-base">
                Your instance actively moderates against hate speech, racism,
                homophobia, and cultures a safe community.
              </p>
